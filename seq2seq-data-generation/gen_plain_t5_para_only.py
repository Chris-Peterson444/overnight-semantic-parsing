...
def writeFile(model, original_file, source_dest_file, target_dest_file):
	...
	for row in original_file:
		...
		for line in paraphrases:
			 ...
			 # Reusing definition of the out line
...
for domain in domain_to_do:
	...
	model_loc = '../../soliloquy_webdemo/paraphrase/quora_paws_model/'
	data_loc = '../../seq2seq_data/cannonical/test_only/'+domain+'/'
	save_loc = '../../../overnight_seq2seq/cannonical/all_domains/plain_t5/'+ str(num_of_examples) + '_examples/' +'test_only/para_only/'+domain+'/data/'
	model = parainfer()
	...
	moveFile(model, valid_file, validation_source_file, validation_target_file)
